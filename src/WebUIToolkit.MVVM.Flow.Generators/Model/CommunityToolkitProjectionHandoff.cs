...
public static class CommunityToolkitProjectionHandoff
{
    ...
    /// <summary>Gets the fully qualified compiler entry-point type identity.</summary>
    public const string CompilerTypeIdentity =
        "WebUIToolkit.MVVM.Build.Symbols.GeneratedMemberContractCompiler";

    /// <summary>Gets the fully qualified Stage 1 compiler method identity.</summary>
    public const string CompilerMethodIdentity =
    ...
    /// <summary>Gets the fully qualified compiler result identity.</summary>
    public const string CompilerResultIdentity =
        "WebUIToolkit.MVVM.Build.Symbols.GeneratedMemberContractResult";

    private static readonly ReadOnlyCollection<string> RequiredDiagnosticIdsValue =
    ...
    /// <summary>Gets the required Stage 1 diagnostics in ascending ordinal identity order.</summary>
    public static IReadOnlyList<string> RequiredDiagnosticIds => RequiredDiagnosticIdsValue;
