...
public sealed record FlowRegistrationDiagnostic
{
    ...
    /// <summary>Gets the stable WUTFLOW identifier.</summary>
    ...
    private static string ValidateDiagnosticId(string id)
    {
        ...
        if (id.Length != 11 || !id.StartsWith("WUTFLOW", StringComparison.Ordinal))
        {
            throw new ArgumentException(
                "A Flow diagnostic identifier must be in the reserved WUTFLOW0001-WUTFLOW0999 range.",
                nameof(id));
        }
