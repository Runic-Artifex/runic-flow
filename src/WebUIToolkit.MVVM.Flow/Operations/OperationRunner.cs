...
public sealed class OperationRunner : IOperationRunner, IOperationMonitor
{
    ...
    private const string CleanupExceptionDataKey = "WebUIToolkit.MVVM.Flow.CleanupException";
    private const string UnlinkedCancellationDataKey = "WebUIToolkit.MVVM.Flow.UnlinkedCancellation";
